			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="<%=request.getContextPath()%>/job/edit"
								method="post" class="form-horizontal form-material">
								<%
									Job job = (Job) request.getAttribute("job");
								%>
								<div class="form-group">
									<label class="col-md-12">Tên dự án</label> <input
										value="<%=job.getId()%>" name="id" type="hidden"
										class="form-control form-control-line">
									<div class="col-md-12">
										<input value=<%=job.getName()%> name="name" type="text"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="<%=job.getStartDate()%>" name="startDate"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value=<%=job.getStartDate()%> name="endDate"
											type="text" placeholder="dd/MM/yyyy"
											class="form-control form-control-line">
									</div>
								</div>
